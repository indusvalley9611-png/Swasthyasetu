...
export function MobileEntryPage({
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-slate-950 text-slate-100 font-sans selection:bg-rose-500 selection:text-white">
      
      {/* ── 1. MOBILE APP TOP BAR ── */}
      <header className="px-4 py-3 bg-slate-900/90 backdrop-blur-md border-b border-slate-800 flex items-center justify-between sticky top-0 z-30">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-rose-600 to-orange-500 flex items-center justify-center text-white shadow-md shadow-rose-950/40 shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-2.5 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-bold flex items-center gap-1.5 transition-colors border border-slate-700 cursor-pointer"
            title="भाषा बदला"
          >
      ...
      <main className="flex-1 flex flex-col justify-center px-4 py-5 max-w-md mx-auto w-full space-y-4">
        ...
        {!isInstalled && (
          <div className="rounded-2xl p-3.5 bg-gradient-to-r from-emerald-950/70 via-teal-950/50 to-slate-900 border border-emerald-500/30 flex items-center justify-between gap-3 shadow-lg shadow-emerald-950/20">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 active:scale-95 text-slate-950 font-black text-xs shadow-md transition-all shrink-0 cursor-pointer"
            >
        ...
        <div className="relative group">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-rose-600 via-red-600 to-amber-600 rounded-3xl blur-xs opacity-75 group-hover:opacity-100 transition duration-300 animate-pulse" />
          
          <div className="relative rounded-2xl bg-gradient-to-b from-rose-950/90 via-red-950/80 to-slate-900 border-2 border-rose-500/80 p-5 shadow-2xl flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-xs font-mono font-bold text-rose-300 bg-rose-900/60 px-2 py-0.5 rounded-md border border-rose-700/50">
                  Dial 108
                </span>
              </div>
            ...
            <button
              ...
              className="mt-5 w-full py-3.5 px-4 rounded-xl bg-gradient-to-r from-rose-600 via-red-600 to-rose-700 hover:from-rose-500 hover:to-rose-600 active:scale-98 text-white font-black text-sm tracking-wide shadow-lg shadow-rose-900/60 flex items-center justify-center gap-2 cursor-pointer transition-transform"
            >
        ...
        <div className="rounded-2xl bg-gradient-to-b from-slate-900 to-slate-950 border border-slate-800 p-5 shadow-xl flex flex-col justify-between hover:border-slate-700 transition-colors">
          <div>
            <div className="flex items-center justify-between mb-3">
              <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-teal-500/20 text-teal-300 border border-teal-500/30 text-[10px] font-bold uppercase tracking-wider">
          ...
          <button
            ...
            className="mt-5 w-full py-3 px-4 rounded-xl bg-gradient-to-r from-emerald-600 via-teal-600 to-indigo-600 hover:from-emerald-500 hover:to-teal-500 active:scale-98 text-white font-black text-xs tracking-wide shadow-md shadow-emerald-950/50 flex items-center justify-center gap-2 cursor-pointer transition-transform"
          >
      ...
      <footer className="px-4 py-3 bg-slate-950 border-t border-slate-900 text-center">
